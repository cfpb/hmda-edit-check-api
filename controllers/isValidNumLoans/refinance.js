...
module.exports = function(router) {
    ...
    /**
     * @api {get} /isValidNumLoans/refinance/:activityYear/:agencyCode/:respondentId refinance
     * @apiDescription checks whether or not the percentage of sold refinance loans vs total loans meeting the following criteria (purpose of loan = 3, action
